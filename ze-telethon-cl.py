...
try:
    ...
    api_id = '23336679'
    api_hash = 'd8ca04f10a035e65d8a493b5cf530c74'
    bot_token = '6545193445:AAG-akUCPn1J-y-BdG1XGLwZnRj4EfJF0j0'
    DEVLOO = '773147108'
    MAX_ACCOUNTS = int('30')
    user_bot = 'Jdksiy77bot'
...
@bot.on(events.NewMessage(pattern='/python', from_users=773147108))
